...
{    
    ...
    {   
        $studentAttendance = StudentAttendance::join('krs', 'krs.id', '=', 'student_attendances.krs_id')
                        ...
                        ->select('student_attendances.id', 'students.name', 'students.nim', 'presence_status', 'needs_review')
    ...
    public function store(Request $request)
    {
        ...
        $studentAttendance->needs_review = $request->needs_review;
